...
function generateClaudeMd(scan, score) {
  ...
  // Attribution
  lines.push('---');
  lines.push('*Generated by [ai-ready](https://github.com/M3phist0s/ai-ready) — customize this file to match your project\'s specific conventions.*');
  lines.push('');
...
function generateCursorRules(scan, score) {
  ...
  // Attribution
  lines.push('# Generated by ai-ready (https://github.com/M3phist0s/ai-ready)');
...
function generateCopilotInstructions(scan, score) {
  ...
  lines.push('---');
  lines.push('*Generated by [ai-ready](https://github.com/M3phist0s/ai-ready) — customize to match your project.*');
  lines.push('');
